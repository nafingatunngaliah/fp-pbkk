...
<head>
    ...
    <!-- Vector CSS -->
    <link href="{{ asset('ample/plugins/bower_components/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
    <!-- animation CSS -->
...
<body class="fix-header">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{{ asset('ample/plugins/images/users/varun.jpg')}}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b><span class="caret"></span> </a>
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="{{ asset('ample/plugins/images/users/varun.jpg')}}" alt="user" /></div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="{{ asset('ample/plugins/images/users/varun.jpg')}}" alt="user-img" class="img-circle"> <span class="hide-menu"> Steve Gection<span class="fa arrow"></span></span>
                        </a>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="javascript:void(0)" class="waves-effect"><i class="ti-email fa-fw"></i> <span class="hide-menu">Email Templates</span><span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li> <a href="{{ asset('ample/email-templates/basic.html')}}"><i class="fa-fw">B</i> <span class="hide-menu">Basic</span></a></li>
                                    <li> <a href="{{ asset('ample/email-templates/alert.html')}}"><i class="ti-alert fa-fw"></i> <span class="hide-menu">Alert</span></a></li>
                                    <li> <a href="{{ asset('ample/email-templates/billing.html')}}"><i class="ti-wallet fa-fw"></i> <span class="hide-menu">Billing</span></a></li>
                                    <li> <a href="{{ asset('ample/email-templates/password-reset.html')}}"><i class="ti-more fa-fw"></i> <span class="hide-menu">Reset Pwd</span></a></li>
                                </ul>
                            </li>
                            ...
                            <div class="vcarousel slide" >
                                ...
                                <div class="carousel-inner">
                                    <div class="active item">
                                        <div class="overlaybg"><img src="{{ asset('ample/plugins/images/heading-bg/slide6.jpg')}}" /></div>
                                    ...
                                    <div class="item">
                                        <div class="overlaybg"><img src="{{ asset('ample/plugins/images/heading-bg/slide4.jpg')}}" /></div>
    ...
    <script src="{{ asset('ample/plugins/bower_components/jquery-sparkline/jquery.charts-sparkline.js')}}"></script>
    <!-- Custom Theme JavaScript -->
    <script src="{{ asset('ample/js/custom.min.js')}}"></script>
    <script src="{{ asset('ample/js/dashboard3.js')}}"></script>
    <!--Style Switcher -->
